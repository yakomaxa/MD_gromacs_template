...
gmx pdb2gmx -f ${1} -o processed_${1}.gro -water tip3p -p topol_${1}.top -ignh < ./dummy/1.txt

# make box
#gmx editconf -f processed_${1}.gro -o newbox_${1}.gro -c -d 1.1 -bt dodecahedron
...
gmx genion -s ions_${1}.tpr -o solv_ions_${1}.gro -p topol_${1}.top -pname NA -nname CL  -neutral  -conc 0.1 -seed 1 < ./dummy/13.txt
